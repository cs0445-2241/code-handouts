...
public interface BagInterface<T>
{
	...
	//Notice how the @return tag specifies both the type and the meaning of the return value	
	...
	/** Adds a new entry to this bag, if possible.
    ...
    */
	...
	//public T[] toArray(); This causes a ClassCastException. For example, String[] values = toArray();

	//Note the return type of the below method.
